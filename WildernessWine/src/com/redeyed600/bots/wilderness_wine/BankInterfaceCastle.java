    ...
    public void execute() {
        ...
        if (ww.GC.outOfSuppies() || Inventory.contains(ww.GC.WINEOFZAMORAK)) {
            ...
            if (Bank.isOpen()) {
                ...
                Bank.depositAllExcept(ww.GC.LAWRUNE,ww.GC.FIRERUNE, ww.GC.AIRRUNE,ww.GC.AIRSTAFF,ww.GC.ENERGYPOTION[0],ww.GC.FOODIDS[0], ww.GC.ARMOUR[0],ww.GC.ARMOUR[1],ww.GC.ARMOUR[2],ww.GC.ARMOUR[3],ww.GC.ARMOUR[4],ww.GC.ARMOUR[5],ww.GC.ARMOUR[6],ww.GC.ARMOUR[7],ww.GC.ARMOUR[8],ww.GC.ARMOUR[9],
